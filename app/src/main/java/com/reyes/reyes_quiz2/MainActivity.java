...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        course1 = findViewById(R.id.it205);
        course2 = findViewById(R.id.ics115);
        course3 = findViewById(R.id.itElec2);
        course4 = findViewById(R.id.ics125);
        course5 = findViewById(R.id.itElec3);
        course6 = findViewById(R.id.itElec4);
        course7 = findViewById(R.id.fElec2);
        course8 = findViewById(R.id.fElec3);
